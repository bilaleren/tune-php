...
/**
 * @see https://developers.tune.com/network/dnelist/
 ...
 * @method object findByOfferId(array|Closure|HttpQueryBuilder $query = null, array $options = [])
 * @method object moveDneList(array|Closure|HttpQueryBuilder $query = null, array $options = [])
 * @method object update(array|Closure|HttpQueryBuilder $query = null, array $options = [])
 */
class DneList extends Controller
{
